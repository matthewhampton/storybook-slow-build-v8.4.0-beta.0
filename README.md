...
Checkout `main` to see the slow version - this takes ~ 2 min on @storybook/core v8.4.0-beta.0 and later,

There is just one tiny test with a single button using the popular bits-ui (and shadcn-svelte that depends on it).
...
Checkout `still-fast` to see it run the fast way it used to - in about 20secs (on @storybook/core v8.4.0-alpha.8 and earlier):
...
storybook-static/iframe.html                         16.34 kB │ gzip:   4.42 kB
storybook-static/assets/preview-CIRcjyVj.js           0.11 kB │ gzip:   0.11 kB
storybook-static/assets/iframe-B8cdYbHq.js            3.06 kB │ gzip:   1.47 kB
storybook-static/assets/preview-B73nlEQ9.js           4.15 kB │ gzip:   2.05 kB
storybook-static/assets/lifecycle-Do_f19cv.js         6.41 kB │ gzip:   2.54 kB
storybook-static/assets/index-BvmOqU8E.js             6.73 kB │ gzip:   3.22 kB
storybook-static/assets/entry-preview-CHvcdIJ7.js   506.07 kB │ gzip: 132.53 kB
storybook-static/assets/Button.stories-Csc6by0x.js  980.36 kB │ gzip: 166.49 kB
